# Acheron 60-SM-S-ATM32U4-MX-HS-WI (Codename "KeebsPCB")
...
The KeebsPCB is a freely available, open-source 60% staggered keyboard Printed Circuit Board (PCB), designed to support Kailh hotswap sockets and a few layouts like Tsangan bottom row. As in all the boards in the Acheron Project, the resources and software used to design this board are open-source and/or freely available.
